...
- серверный поиск по `q`, профиль и полноценное наполнение информационных
  страниц ещё не реализованы.
...
- На мобильных ширинах desktop-поиск скрывается, нижняя навигация фиксируется
  у нижнего края. На desktop нижняя навигация скрыта.
...
- Поле поиска отправляет GET-параметр `q` в `catalog:index`, но серверная
  фильтрация ещё не реализована. Не выдавайте визуальную форму за рабочий поиск.
