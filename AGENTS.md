...
- корзина, checkout, серверный поиск по `q`, профиль и полноценное наполнение
  информационных страниц ещё не реализованы.
...
- Кнопки добавления в корзину пока являются только UI-заготовкой до реализации
  session-based корзины.
